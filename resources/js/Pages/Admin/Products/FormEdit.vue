<template>
    <AdminLayout>
        ...
        <template #content>
            ...
            <form @submit.prevent="editProduct" class="bg-white shadow p-5 flex flex-col gap-3">
                ...
                <!-- SUBMIT -->
                <button type="submit" class="bg-indigo-800 hover:bg-indigo-900 transition-all text-white py-2 uppercase">Editar producto</button>
            </form>
